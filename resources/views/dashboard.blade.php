<x-layouts.app>
    ...
    <div class="mb-6 grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-start justify-between gap-4">
                ...
                <div class="shrink-0 rounded-full bg-blue-100 p-3 text-blue-600 dark:bg-blue-900/50 dark:text-blue-300">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">{{ __('Resumen de recaudación') }}</p>       
                </div>
                <div class="shrink-0 rounded-full bg-amber-100 p-3 text-amber-600 dark:bg-amber-900/50 dark:text-amber-300">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-start justify-between gap-4">
                <div>
                 ...
                 <div class="shrink-0 rounded-full bg-green-100 p-3 text-green-600 dark:bg-green-900/50 dark:text-green-300">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-start justify-between gap-4">
                ...
                <div class="shrink-0 rounded-full bg-purple-100 p-3 text-purple-600 dark:bg-purple-900/50 dark:text-purple-300">
    ...
    <div class="mb-6 grid grid-cols-1 gap-6 xl:grid-cols-2">
         <section class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-start justify-between gap-4 border-b border-gray-200 p-6 dark:border-gray-700">
                <div>
                ...
                @can('manage-fees')
                    <a href="{{ route('members.fee-payments.index') }}" class="shrink-0 text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400">{{ __('Ver cuotas') }}</a>
                @endcan
            </div>
        ...
        <section class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-start justify-between gap-4 border-b border-gray-200 p-6 dark:border-gray-700">
                ...
                @can('manage-enrollments')
                    <a href="{{ route('enrollment-requests.index') }}" class="shrink-0 text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400">{{ __('Ver todas') }}</a>
                @endcan
            </div>
            <div class="divide-y divide-gray-100 dark:divide-gray-700">
                @forelse ($latestEnrollments as $enrollment)
                    <div class="flex items-center justify-between gap-4 p-5">
                        <div>
                         ...
                         <span class="shrink-0 rounded-full bg-blue-100 px-2 py-1 text-xs font-medium text-blue-700 dark:bg-blue-900/50 dark:text-blue-300">{{ $enrollment->statusLabel() }}</span>
                    </div>
                @empty
