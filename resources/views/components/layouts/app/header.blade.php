...
<header class="bg-white dark:bg-gray-800 shadow-sm z-20 border-b border-gray-200 dark:border-gray-700">
    <div class="flex items-center justify-between h-16 px-4">
        ...
        <div class="flex items-center">
            ...
            <div class="ml-4 font-semibold text-xl text-blue-600 dark:text-blue-400">Centro Futbol Futbol</div>
        </div>
        ...
        <div class="flex items-center space-x-4">
            ...
            <div x-data="{ open: false }" class="relative">
                <button @click="open = !open" class="flex items-center focus:outline-none">
                    ...
                    <span class="ml-2 hidden rounded-full bg-blue-50 px-2 py-0.5 text-xs font-semibold text-blue-700 dark:bg-blue-900/50 dark:text-blue-200 lg:inline">{{ Auth::user()->roleLabel() }}</span>
