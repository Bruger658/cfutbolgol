...
<div class="space-y-4">
     @if ($errors->any())
        <div class="rounded border border-red-500/60 bg-red-500/10 p-3 text-sm text-red-200">
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route('noticias.index') }}" class="text-sm text-on-surface-variant hover:text-on-surface">Cancelar</a>
    </div>
</div>
